...
def get_movie_url(url):
    ...
    movie_herfs = selector.xpath('//div[@class="hd"]/a/@href')
    for movie_herf in movie_herfs:
        get_movie_info(movie_herf)
...
def get_movie_info(url):
    ...
    try:
        ...
        style = selector.xpath('//*[@id="info"]/span[@property="v:genre"]/text()')[0]
...
if __name__ == '__main__':
    urls = ['https://movie.douban.com/top250?start={}'.format(str(i)) for i in range(0, 100, 25)]
    for url in urls:
